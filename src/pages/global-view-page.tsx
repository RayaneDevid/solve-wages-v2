    ...
    try {
      await saveEntries.mutateAsync({
        ...
        entries: [{
          ...
          nb_animations_mj_p: updated.nb_animations_mj_p,
          nb_animations_mj_m: updated.nb_animations_mj_m,
          nb_animations_mj_g: updated.nb_animations_mj_g,
          nb_heures_mj: updated.nb_heures_mj,
