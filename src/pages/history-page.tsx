...
import { t } from '@/i18n';
import { Pole, type PayrollWeek, type PayrollEntry, type PayrollSubmissionLog, type PayrollSubmissionLogChange } from '@/types';
import { formatDate, formatShortDate } from '@/lib/utils';
import { POLE_LABELS } from '@/lib/constants';
import { usePayrollWeeks, usePayrollEntries, useExportPayroll, usePayrollSubmissionLogs } from '@/hooks/queries/use-payroll';
...
function SubmissionLogList({ logs }: { logs: PayrollSubmissionLog[] }) {
  const tr = t();
