-- Add new pole types
ALTER TYPE pole_type ADD VALUE 'builder';
ALTER TYPE pole_type ADD VALUE 'lore';
ALTER TYPE pole_type ADD VALUE 'equilibrage_pvp';
ALTER TYPE pole_type ADD VALUE 'community_manager';
ALTER TYPE pole_type ADD VALUE 'support';

-- Add new user roles
ALTER TYPE user_role ADD VALUE 'resp_builder';
ALTER TYPE user_role ADD VALUE 'builder';
ALTER TYPE user_role ADD VALUE 'resp_lore';
ALTER TYPE user_role ADD VALUE 'lore';
ALTER TYPE user_role ADD VALUE 'resp_equilibrage_pvp';
ALTER TYPE user_role ADD VALUE 'equilibrage_pvp';
ALTER TYPE user_role ADD VALUE 'resp_cm';
ALTER TYPE user_role ADD VALUE 'cm';

-- Update get_pole_for_role to include new roles
...
-- Update is_pole_responsible to include new resp roles
