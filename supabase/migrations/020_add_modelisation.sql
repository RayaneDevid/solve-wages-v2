-- Add new pole type
ALTER TYPE pole_type ADD VALUE 'modelisation';

-- Add new user roles
ALTER TYPE user_role ADD VALUE 'resp_modelisation';
ALTER TYPE user_role ADD VALUE 'modelisateur';
...
-- Update is_pole_responsible to include new resp role
